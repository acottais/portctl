...
func (m *PluginConfig) validateDescription(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Config"+"."+"Description", "body", string(m.Description)); err != nil {
		return err
	}
...
func (m *PluginConfig) validateDocumentation(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Config"+"."+"Documentation", "body", string(m.Documentation)); err != nil {
		return err
	}
...
func (m *PluginConfig) validatePropagatedMount(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Config"+"."+"PropagatedMount", "body", string(m.PropagatedMount)); err != nil {
		return err
	}
...
func (m *PluginConfig) validateWorkDir(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Config"+"."+"WorkDir", "body", string(m.WorkDir)); err != nil {
		return err
	}
...
func (m *PluginConfigArgs) validateDescription(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Config"+"."+"Args"+"."+"Description", "body", string(m.Description)); err != nil {
		return err
	}
...
func (m *PluginConfigArgs) validateName(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Config"+"."+"Args"+"."+"Name", "body", string(m.Name)); err != nil {
		return err
	}
...
const (
	...
	// PluginConfigInterfaceProtocolScheme captures enum value ""
	PluginConfigInterfaceProtocolScheme string = ""

	// PluginConfigInterfaceProtocolSchemeMobyPluginsHTTPV1 captures enum value "moby.plugins.http/v1"
	PluginConfigInterfaceProtocolSchemeMobyPluginsHTTPV1 string = "moby.plugins.http/v1"
)

// prop value enum
func (m *PluginConfigInterface) validateProtocolSchemeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, pluginConfigInterfaceTypeProtocolSchemePropEnum); err != nil {
		return err
	}
	return nil
}
...
func (m *PluginConfigInterface) validateSocket(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Config"+"."+"Interface"+"."+"Socket", "body", string(m.Socket)); err != nil {
		return err
	}
...
func (m *PluginConfigNetwork) validateType(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Config"+"."+"Network"+"."+"Type", "body", string(m.Type)); err != nil {
		return err
	}
