...
// EndpointGroupCreateRequest endpoint group create request
// swagger:model EndpointGroupCreateRequest
...
func (m *EndpointGroupCreateRequest) validateLabels(formats strfmt.Registry) error {
...
func (m *EndpointGroupCreateRequest) validateName(formats strfmt.Registry) error {
...
func (m *EndpointGroupCreateRequest) UnmarshalBinary(b []byte) error {
	var res EndpointGroupCreateRequest
