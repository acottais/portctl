...
// swagger:model TemplateUpdateRequest
...
func (m *TemplateUpdateRequest) validateEnv(formats strfmt.Registry) error {
...
func (m *TemplateUpdateRequest) validateLabels(formats strfmt.Registry) error {
...
func (m *TemplateUpdateRequest) validateRepository(formats strfmt.Registry) error {
...
func (m *TemplateUpdateRequest) validateVolumes(formats strfmt.Registry) error {
