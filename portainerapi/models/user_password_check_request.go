...
// UserPasswordCheckRequest user password check request
// swagger:model UserPasswordCheckRequest
...
func (m *UserPasswordCheckRequest) validatePassword(formats strfmt.Registry) error {
...
func (m *UserPasswordCheckRequest) UnmarshalBinary(b []byte) error {
	var res UserPasswordCheckRequest
