...
for the team create operation typically these are written to a http.Request
*/
...
func (o *TeamCreateParams) WithBody(body *models.TeamCreateRequest) *TeamCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the team create params
func (o *TeamCreateParams) SetBody(body *models.TeamCreateRequest) {
	o.Body = body
}
